...
<tr>
  <th scope="col" abbr="Name" style="width: 100px;">Name</th>
  <th scope="col" abbr="status" style="width: 100px;">Address</th>
  <th scope="col" abbr="phone" style="width: 100px;">Phone</th>
...
while (rs.next ()){
    ...
    %> 
      <form action="staffs/delete.jsp" method="post">
   <tr>
    <td><%=name %></td>
<td><%=add %></td>
