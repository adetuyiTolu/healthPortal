...
isNumberKey(e)
    ...
    <body>
        ...
        <div  align="center" id="form">
            <form name="wardu"  method='post' action="beds/updatec.jsp" enctype="multipart/form-data" name="contact_form" class='contact_form' accept-charset='UTF-8' id="sub">
                <ul>
                     <li>
                        <h2>Update Beds Form</h2>
                    </li>
                     <div class='container'>
                         <li><label for="name"> Ward/Bed Code.:</label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <%
                                try {
