    ...
    <table width="918" border="0">
      ...
      <table width="918" border="0">
        <tr>
          ...
          <tr>
              <td id="vie" width="231" height="50" bgcolor="#FFFFFF"><img src="images/HomeIcon.jpg" width="45" height="45">View All Users</td>
            </tr>
            <tr >
                <td id="ad" height="50" bgcolor="#FFFFFF"> <img  src="images/add-contact-app-icon.png" width="45" height="45" alt="Admit"> Add User</td>
            </tr>
            <tr>
              <td id="updat" height="50" bgcolor="#FFFFFF"><img src="images/b_edit.png" width="35" height="35" alt="services">Update User</td>
            </tr>
            <td id="exit" height="50" bgcolor="#FFFFFF"><img src="images/help.jpg" width="45" height="45">Exit Staff </td>
            </tr>
            <tr>
        ...
        <div id="view" >
           <jsp:include page="system/view.jsp"/></div>
        <div id="add" >
          <jsp:include page="system/add.jsp"/></div>
           
          <div id="update"><jsp:include page="system/update.jsp"/></div>
        </td>
        </tr>
      </table>
