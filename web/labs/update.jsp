...
isNumberKey(e)
    ...
    <body>
        ...
        <div  align="center" id="form">
            <form  method='post' action="labs/updatec.jsp" enctype="multipart/form-data" name="contact_form" class='contact_form' accept-charset='UTF-8' id="sub">
                <ul>
                    <li>
                             <h2>Update Lab Service Form</h2>
                    </li>
                    <div class='container'>
                         <li><label for="name"> Drug Name.:</label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <%
                                try {
