...
<tr>
  ...
  <th scope="col" abbr="phone" style="width:109px;">Reg. No</th>
  <th></th>
</tr>      
<%
try {

 String sql = "SELECT * FROM patient where status='outpatient'";  
...
%>
  <tr><td><button class="submit" type="submit" name="printo" id="printo">Print</button></td></tr>
  </table> 