    ...
    <table width="918" border="0">
      ...
      <table width="918" border="0">
        <tr>
          ...
          <tr>
              <td id="vie" width="231" height="50" bgcolor="#FFFFFF"><img src="images/HomeIcon.jpg" width="45" height="45">&nbsp;&nbsp;&nbsp;Staffs Home</td>
            </tr>
            <tr >
                <td id="ad" height="50" bgcolor="#FFFFFF"> <img  src="images/add-contact-app-icon.png" width="45" height="45" alt="Admit"> Add Staff</td>
            </tr>
            <tr>
              <td id="updat" height="50" bgcolor="#FFFFFF"><img src="images/b_edit.png" width="35" height="35" alt="services">Update Staff</td>
            </tr>
        ...
        <div id="view" >
           <jsp:include page="staffs/view.jsp"/></div>
        <div id="add" >
          <jsp:include page="staffs/add.jsp"/></div>
           
          <div id="update"><jsp:include page="staffs/update.jsp"/></div>
        </td>
        </tr>
      </table>
