    ...
    <table width="918" border="0">
      ...
      <table width="918" border="0">
        <tr>
          ...
          <tr>
            <td id="vie" width="231" height="50" bgcolor="#FFFFFF"><img src="images/ser.png" width="45" height="45">&nbsp;&nbsp;&nbsp;View Drugs</td>
            </tr>
            <tr>
              <td id="viel" width="231" height="50" bgcolor="#FFFFFF"><img src="images/ser.png" width="45" height="45">&nbsp;&nbsp;&nbsp;View Lab Services</td>
            </tr>
            <tr >
              <td id="ad" height="50" bgcolor="#FFFFFF"> <img  src="images/add-contact-app-icon.png" width="45" height="45" alt="Admit"> Add Drugs</td>
            </tr>
            <tr >
              <td id="adl" height="50" bgcolor="#FFFFFF"> <img  src="images/add-contact-app-icon.png" width="45" height="45" alt="Admit"> Add Lab Service</td>
            </tr>
            <tr>
              <td id="updat" height="50" bgcolor="#FFFFFF"><img src="images/b_edit.png" width="35" height="35" alt="services">Update Drug</td>
            </tr>
            <tr>
              <td id="updatl" height="50" bgcolor="#FFFFFF"><img src="images/b_edit.png" width="35" height="35" alt="services">Update Lab Service</td>
            </tr>
              <td id="exit" height="50" bgcolor="#FFFFFF"><img src="images/help.jpg" width="45" height="45">Exit Drugs/Lab </td>
            </tr>
            <tr>
        ...
        <div id="view" >
           <jsp:include page="drugs/view.jsp"/></div>
        <div id="add" >
          <jsp:include page="drugs/add.jsp"/></div>
           
          <div id="update"><jsp:include page="drugs/update.jsp"/></div>
            <div id="viewl" >
           <jsp:include page="labs/view.jsp"/></div>
        <div id="addl" >
          <jsp:include page="labs/add.jsp"/></div>
           
          <div id="updatel"><jsp:include page="labs/update.jsp"/></div>
        </td>
        </tr>
      </table>
