...
isNumberKey(e)
    ...
    <body>
        ...
        <div  align="center" id="form">
            <form  method='post' action="drugs/updatec.jsp" enctype="multipart/form-data" name="contact_form" class='contact_form' accept-charset='UTF-8' id="sub">
                <ul>
                    <li>
                        <h2>Update Drug Form</h2>
                    </li>
                    <div class='container'>
