...
isNumberKey(e)
    ...
    <body>
        ...
        <div  align="center" id="form">
            <form  method='post' action="beds/addc.jsp" enctype="multipart/form-data" name="contact_form" class='contact_form' accept-charset='UTF-8' id="sub">
                <ul>
                    <li>
                        <h2>Add Beds Form</h2>
                    ...
                    <li>
                        ...
                        <span class="form_hint">Room code is required</span>
                    </li>
